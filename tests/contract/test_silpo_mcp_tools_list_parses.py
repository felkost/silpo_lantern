"""Recorded contract test (docs/g1-g2-stage-spec.md section 7): the G0
evidence-lab `tools/list` snapshot, copied into a tracked fixture (round 2,
Lane 3 fix — the original `docs/evidence/...` path is gitignored and would
break on a fresh clone/CI checkout, violating CLAUDE.md's "a tracked file may
only reference tracked files"). Confirms the fixture parses into typed `Tool`
